...
public class PermissaoDAOJDBC implements PermissaoDAO {
    ...
    public int inserir(Permissao permissao) throws ClassNotFoundException, SQLException, SQLIntegrityConstraintViolationException {
        ...
        sqlBuilder
                .append("insert into permissao(permissao, data) ")
                .append("VALUES (?, ?)");
    ...
    public List<Permissao> listar() {
        ...
        try {        
            ...
            while (rset.next()) {
                ...
                permissao.setPermissao(rset.getString("permissao"));
    ...
    public int editar(Permissao permissao) {
      StringBuilder sqlBuilder = new StringBuilder();
        ...
        int linha = 0;
        try {
            linha = DAOGenerico.executarComando(update, permissao.getPermissao(),
                                                        permissao.getId());
        } catch (Exception e) { 
            e.printStackTrace();
        } 
